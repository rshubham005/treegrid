{
    Cfg : {
       ...
       Paging:'1',ChildPaging:'0',// Both paging set to server
       Pager:'0',
       ChildPageLength:"25", // Server paging for child pages, splits children to given number of rows and loads them separately when they become visible due scroll
    ...
    Actions: { 
       ...
       OnClickButtonReload:'Grid.Component.handleExperiment()'
    }, 
    Lang: { 
    ...
    Header: {
        ...
        PANNumber:'PAN Number',CIDNumber:'CID Number',PANGSTNumber:'PAN GST Number',ARNNumber:'sdfjgnjbsjefbsdjdsdlfjsdfjfdlsd',BirthDate:'Date of Birth'
        },

    Head:[
        {
            Kind:'Filter',CanEdit:'1'
        },
        {
            Kind:'Search',CanEdit:'1', Width:'100'
        }
